...
class Intermediate:
    ...
    """
    def __init__(self, code=None, molecule=None, graph=None, energy=None,
                 formula=None):
        self.code = code
    ...
    @classmethod
    def from_molecule(cls, molecule, code=None, energy=None):
        ...
        new_inter = cls(code=code, molecule=new_mol, graph=new_graph,
                        formula=new_formula, energy=energy)
        return new_inter
...
class OrganicNetwork:
    ...
    """
    def __init__(self, intermediates=None, t_states=None):
    ...
    def search_graph(self, mol_graph, cate=None):
        ...
        """
        if cate is None:
            cate = iso.categorical_node_match(['elem', 'elem', 'elem'], ['H', 'C', 'O'])
        coinc_lst = []
