...
OFile = 'microkinetics/ya-3s-brettphos/ya-3s-brettphos-results.csv'
...
def model(t,x):
    ...
    dxdt[1] = +r02-r03-r04+r05-r14+r15-r24+r25
    dxdt[2] = +r04-r05-r06+r07+r26-r27
...
def jacobian(t,x):
    ...
    Jac[6,7] = +k17
    Jac[7,6] = +k16
    Jac[7,7] = -k17-k18*x[13]
    Jac[7,8] = +k19*x[14]
    Jac[7,13] = -k18*x[7]
    Jac[7,14] = +k19*x[8]
    Jac[8,7] = +k18*x[13]
    Jac[8,8] = -k19*x[14]-k20
    Jac[8,9] = +k21
    Jac[8,13] = +k18*x[7]
    Jac[8,14] = -k19*x[8]
    Jac[9,0] = +k23*x[16]
